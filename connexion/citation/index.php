<?php
	...
	$mvcitation = mysql_real_escape_string(htmlspecialchars($_GET['citation']));
                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                            <form method="post" action="trait_modif_citation.php">
                            <?php
                                echo("<h2>$nom ");
                                echo("$prenom</h2>");
                                ...
                                echo("<p>Votre citation : <textarea name='citation'>$citation</textarea><div class='bouton2'><input type='submit' value='Modifier'/>$mvcitation</p></div>");
                            ?>
