	...
	<body name="menu"> 
            ...
            <div class="content">       
                <div class="inner">
					...
					<div class="colGauche">
						<select>
							<option>Sélectionnez le nombre d'ingrédients </option>
							<option onClick="change(1)">1</option>
							<option onClick="change(2)">2</option>
							<option onClick="change(3)">3</option>
						</select>
