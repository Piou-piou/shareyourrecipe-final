                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                        	<h5>Bienvenue sur votre espace personnel ! Vous pouvez désormais noter, commenter ou proposer vos recettes...et plus encore !</h5>
							
							<?php
                                echo("<img src='$img_profil' width='130' height='100'/> <br>");
                                echo("<h2>$prenom $nom</h2>");
                                echo("<p>$pseudo</p>");
                                echo("<p>Votre mail : $mail</p>");
                                echo("<p>Votre date de naissance : $date</p>");
                                echo("<p>Votre citation : $citation</p>");
                            ?>
                            <p><a href="ajouter_une_recette/index.php">Ajouter une recette</a></p>
                            <p><a href="affiche_mesrecettes.php">Afficher mes recettes</a></p>
                            
                            <div class="paramettre">
                                <p><a href="logout.php">Se déconnecter</a></p>
                                <p><a href="modif_compte.php">Modifier des informations sur se compte</a></p>
                                <p><a href="signout.php">Supprimer ce compte</a></p>
                            </div>
                    	</div>
                    </div> <!--FIN COLGAUCHE-->
