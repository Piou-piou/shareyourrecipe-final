<?php
	...
	$mvimg = stripslashes(htmlspecialchars_decode($_GET['image']));
                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                            <form method="post" action="trait_modif_image.php" enctype="multipart/form-data">
                            <?php
                                echo("<h2>$prenom ");
                                echo("$nom</h2>");
                            ?>
							...
							<?php
								echo("<div class='bouton2'><input type='submit' value='Modifier'/> $mvimg </p></div>");
							?>
