<?php
	...
	$mvpseudo = mysql_real_escape_string(htmlspecialchars($_GET['pseudo']));
                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                            <form method="post" action="trait_modif_pseudo.php">
                            <?php
                                echo("<h2>$nom ");
                                echo("$prenom</h2>");
                                echo("<p>Votre pseudo : <input type='text' value='$pseudo' name='pseudo'><div class='bouton2'><input type='submit' value='Modifier'/> $mvpseudo </p></div>");
