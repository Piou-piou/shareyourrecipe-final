<?php
	...
	$mvmail = mysql_real_escape_string(htmlspecialchars($_GET['mail']));
                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                            <form method="post" action="trait_modif_mail.php">
                            <?php
                                echo("<h2>$nom ");
                                echo("$prenom</h2>");
                                echo("<p>Votre pseudo : $pseudo</p>");
                                echo("<p>Votre mail : <input type='text' value='$mail' name='mail'><div class='bouton2'><input type='submit' value='Modifier'/> $mvmail</p></div>");
