<?php
	...
	$mvmdp = mysql_real_escape_string(htmlspecialchars($_GET['mdp']));
	$mvverifmdp = mysql_real_escape_string(htmlspecialchars($_GET['verif_mdp']));
                ...
                <div class="inner">
					...
					<div class="colGauche">
                    	<div class="contenuphpmembre">
                            <form method="post" action="trait_modif_mdp.php">
                            <?php
                                echo("<p>Votre ancien mot de passe : <input type='password' name='mdp'/></p>");
                                echo("<p>Votre nouveau mot de passe : <input type='password' name='mdp_new'/></p>");
                                echo("<p>Re-tapez votre nouveau mot de passe  : <input type='password' name='verif_mdp_new'/> </p>");
                                echo("<p>$mvmdp </p>");
                                echo("<p>$mvverifmdp </p>");
                            ?>
                            ...
                            <input type="hidden" name="submitted" id="submitted" value="true"/>
                           	...
                           	<div class="paramettre">
                            	<p><a href="../modif_compte.php">Retour en arrière</a></p>
                            </div>
                    	</div>
                    </div> <!--FIN COLGAUCHE-->
